// Class Villain ini mewarisi class abstract Character dan mengimplementasikan interface Behaviour
public class Villain extends Character implements Behaviour{
    // Variabel count ini saya gunakan untuk menghitung berapa kali spesial skill pernah digunakan oleh salah satu objek Villain. Modifier private, diakses dari class lain dengan setter dan getter.
    private int count;

    // Method ini adalah constructor dari class Villain, constructor ini hanya memanggil constructor dari superclass, yaitu class Character.
    public Villain(String name, int health, int attack){
        super(name, health, attack);
    }

    // Method attack ini adalah method yang digunakan untuk attack hero. Parameter tipenya Character agar kompatibel dengan Villain dan Hero (method ini dipanggil di spesialSkill).
    ...
    // Method showCharacter ini digunakan untuk menampilkan nama villain, health villain, dan attack dari villain. Method ini sebenarnya adalah overriding dari method yang ada di class Character.
    public void showCharacter(){
        System.out.println("Villain: " + getName() + " | Health: " + getHealth() + " | Attack: " + getAttack());
    }

    // Method dead ini digunakan untuk memberi tahu bahwa villain berhasil dikalahkan atau hero menang. Method ini adalah overriding dari method di interface Behaviour. 
